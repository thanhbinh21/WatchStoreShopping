        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm leading-relaxed mb-4">
              Chuyên cung cấp các sản phẩm đồng hồ cao cấp, từ các thương hiệu nổi tiếng trên thế giới.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <a href="/collections" className="hover:text-white transition-colors text-sm">
                  Bộ sưu tập
                </a>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="/categories/mechanical" className="hover:text-white transition-colors text-sm">
                  Đồng hồ Cơ khí
                </a>
              </li>
              <li>
                <a href="/categories/quartz" className="hover:text-white transition-colors text-sm">
                  Đồng hồ Pin
                </a>
              </li>
              <li>
                <a href="/categories/smartwatch" className="hover:text-white transition-colors text-sm">
                  Đồng hồ Thông minh
                </a>
              </li>
              <li>
                <a href="/categories/diving" className="hover:text-white transition-colors text-sm">
                  Đồng hồ Lặn
                </a>
              </li>
              <li>
                <a href="/categories/fashion" className="hover:text-white transition-colors text-sm">
                  Đồng hồ Thời trang
                </a>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+84901234567" className="text-sm hover:text-white transition-colors">
                  +84 90 123 4567
                </a>
              </li>
              <li className="flex items-center gap-3">
