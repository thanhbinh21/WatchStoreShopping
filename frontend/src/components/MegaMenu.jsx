...
const MegaMenu = ({ categories, brands, isOpen, onClose }) => {
  ...
  const handleBrandClick = (brandId) => {
    handleNavigate(`/products?brand=${brandId}`);
  };
      ...
      <div className="grid grid-cols-4 gap-6 p-6">
        ...
        <div>
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 mt-2">
              <button
                onClick={() => handleNavigate("/promotional-products?status=active")}
              ...
              <button
                onClick={() => handleNavigate("/promotional-products?status=upcoming")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center gap-2"
              >
              ...
              <button
                onClick={() => handleNavigate("/promotional-products?status=ended")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center gap-2"
              >
        ...
        <div>
          ...
          <div className="space-y-1">
            ...
            <div className="space-y-0.5 mt-2">
              <button
                onClick={() => handleNavigate("/posts?category=news")}
              ...
              <button
                onClick={() => handleNavigate("/posts?category=review")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center justify-between group"
              >
              ...
              <button
                onClick={() => handleNavigate("/posts?category=guide")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center justify-between group"
              >
              ...
              <button
                onClick={() => handleNavigate("/posts?category=tips")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center justify-between group"
              >
                <span>Mẹo hay</span>
                <ChevronRight size={14} className="opacity-0 group-hover:opacity-100 transition-opacity" />
              ...
              <button
                onClick={() => handleNavigate("/posts?category=events")}
                className="w-full text-left px-3 py-2 text-sm text-foreground hover:text-brand-primary hover:bg-brand-accent-soft/50 rounded transition-colors flex items-center justify-between group"
              >
                <span>Sự kiện</span>
                <ChevronRight size={14} className="opacity-0 group-hover:opacity-100 transition-opacity" />
