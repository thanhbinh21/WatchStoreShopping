                            ...
                            {wishlist.map((product) => (
                                ...
                                >
                                    ...
                                    <div className="p-5">
                                        ...
                                        <h3
                                            onClick={() => handleProductClick(product.id)}
                                            className="text-lg font-semibold text-gray-900 line-clamp-2 mb-2 min-h-12 cursor-pointer hover:text-red-600 transition-colors"
                                        >
                                            {product.name}
                                        </h3>
                                        ...
                                        <div className="flex gap-2">
                                            <button
                                                ...
                                                className="flex-1 flex items-center justify-center gap-2 bg-red-600 text-white rounded-lg py-2.5 hover:bg-red-700 transition-colors font-medium"
                                            >
