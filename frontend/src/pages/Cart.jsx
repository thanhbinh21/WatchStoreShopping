...
export default function Cart() {
  ...
  const loadCart = async () => {
        ...
        for (const it of items) {
          if (Number.isFinite(it.stock) && it.quantity > it.stock) {
            ...
            try {
              ...
              console.error("Failed to adjust cart item due to stock change", e);
            }
          }
        }
        if (loginModified) {
          toast.warning("Một số sản phẩm trong giỏ đã được điều chỉnh vì tồn kho thay đổi");
        }
        setCartItems(items);
        return;
      } catch (err) {
    ...
    if (modified) {
      ...
      toast.warning("Số lượng một số sản phẩm đã được điều chỉnh do tồn kho thay đổi");
    }
        ...
        {cartItems.map((item) => {
          ...
          return (
            ...
            >
                ...
                {hasPromotion && (
                  <p className="text-green-600 text-sm mt-1 font-medium flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 mr-1" viewBox="0 0 20 20" fill="currentColor">
                      <path fillRule="evenodd" d="M5 2a1 1 0 011 1v1h1a1 1 0 010 2H6v1a1 1 0 01-2 0V6H3a1 1 0 010-2h1V3a1 1 0 011-1zm0 10a1 1 0 011 1v1h1a1 1 0 110 2H6v1a1 1 0 11-2 0v-1H3a1 1 0 110-2h1v-1a1 1 0 011-1zm7-10a1 1 0 01.707.293l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L14.586 9H3a1 1 0 010-2h11.586l-2.293-2.293A1 1 0 0112 2z" clipRule="evenodd" />
                    </svg>
              ...
              <div 
                className="flex flex-col items-end justify-between h-full ml-4"
              >
                <button
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex flex-col items-end">
              <p className="text-gray-600 text-sm mb-1">
                Đã chọn <span className="font-bold">{selectedItems.length}</span> sản phẩm
              </p>
              <button
