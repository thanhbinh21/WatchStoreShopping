...
export const AdminBrands = () => {
  ...
  const fetchBrands = useCallback(async () => {
    try {
      ...
      console.log("Brands with status:", sortedBrands.map(b => ({ id: b.id, name: b.name, status: b.status })));
  ...
  const handleSubmitAdd = async (e, uploadedLogoUrl = null) => {
    ...
    try {
      const dataToSubmit = uploadedLogoUrl ? { ...formData, logoUrl: uploadedLogoUrl } : formData;
