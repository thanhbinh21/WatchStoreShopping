...
import { getAllChatRooms, getChatMessages, markChatAsRead, getAdminUnreadCount } from "@/api/chatAPI";
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-500">
                                    {selectedRoom.isUserOnline ? (
                                        ...
                                        <span>
                                            Hoạt động {selectedRoom.userLastSeen ? formatDate(selectedRoom.userLastSeen) : "chưa rõ"}
                                        </span>
                                    )}
                                </p>
                            </div>
                        ...
                        <form onSubmit={handleSend} className="p-4 bg-white border-t border-gray-200">
                            <div className="flex gap-2">
                                <input
                                    ...
                                    disabled={!connected}
                                    className="flex-1 px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500 disabled:bg-gray-100"
                                />
                                <button
                                    type="submit"
                                    disabled={!connected || !inputMessage.trim()}
                                    className="bg-red-600 hover:bg-red-700 text-white px-6 py-3 rounded-lg transition-colors disabled:bg-gray-300 disabled:cursor-not-allowed"
                                >
                                    <Send size={20} />
                                </button>
                            </div>
